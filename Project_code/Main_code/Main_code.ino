...
    Serial.println("Failed to obtain time for sessionID");
...
    configTime(19800, 0, "pool.ntp.org"); // IST (GMT+5:30), no DST
...
        }
        if(!step_detect){
            Firebase.set(fbdo, "/"+sessionID+"/stepCount", stepCount);
        }
